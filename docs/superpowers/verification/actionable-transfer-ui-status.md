# Actionable Transfer UI Verification

- Result: **FAIL**
- Verified at: 2026-07-12T02:49:29Z
- Branch: feature/user-friendly-dashboard
- Commit tested: 66482c2efff88fd862ad04163ec61ba3791061d7 plus the focused integration patch in this run
...
Restoring NuGet package NUnitLite.3.14.0.
  ...
  OK https://api.nuget.org/v3-flatcontainer/nunitlite/3.14.0/nunitlite.3.14.0.nupkg 8ms
  OK https://api.nuget.org/v3-flatcontainer/playnitesdk/6.16.0/playnitesdk.6.16.0.nupkg 18ms
  OK https://api.nuget.org/v3-flatcontainer/nunit/3.14.0/nunit.3.14.0.nupkg 27ms
...
Added package 'NUnitLite.3.14.0' to folder 'D:\a\PersonalCloudLibrarySource\PersonalCloudLibrarySource\PersonalCloudLibrarySource\packages'
  ...
  OK https://api.nuget.org/v3/vulnerabilities/index.json 6ms
  ...
  OK https://api.nuget.org/v3-vulnerabilities/2026.07.10.06.21.10/vulnerability.base.json 5ms
  OK https://api.nuget.org/v3-vulnerabilities/2026.07.10.06.21.10/2026.07.11.12.21.15/vulnerability.update.json 90ms
...
Build started 7/12/2026 2:49:21 AM.
...
CoreCompile:
  ...
  Setting DOTNET_TieredCompilation to '0'
  Successfully created process with process id 2732
